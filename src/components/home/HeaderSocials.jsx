...
const HeaderSocials = () => {
    return(
        ...
        <div className="home__socials">
            <a href="https://www.instagram.com/taek_ahn/" className="home__social-link" target="__blink">
                <i class="fa-brands fa-instagram"></i>
            </a>

            <a href="https://github.com/TaeKyoungAhn" className="home__social-link" target="__blink">
